...
public sealed class SqlServerInfoDto
{
    ...
    public string Status { get; set; } = string.Empty;
    public List<KeyValuePair<string, string>> Facts { get; set; } = [];
}
...
public sealed class SqlColumnEditDto
{
    ...
    public string Extra { get; set; } = string.Empty;
    public string Comment { get; set; } = string.Empty;
    public string PositionMode { get; set; } = "end";
    public string AfterColumn { get; set; } = string.Empty;
    public int Ordinal { get; set; }
}
...
public sealed class SqlExportRequest
{
    ...
    public string Format { get; set; } = "sql";
    ...
    public List<Dictionary<string, string?>> SelectedRows { get; set; } = [];
}
...
public sealed class SqlImportRequest
{
    ...
    public bool DisableForeignKeyChecks { get; set; } = true;
...
public sealed class SqlIndexDto
{
    public string Name { get; set; } = string.Empty;
...
public sealed class SqlIndexCrudRequest
{
    public string ProfileId { get; set; } = string.Empty;
    public string DatabaseName { get; set; } = string.Empty;
    public string Schema { get; set; } = string.Empty;
    ...
    public string OriginalName { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public string IndexType { get; set; } = "INDEX";
    public List<string> Columns { get; set; } = [];
}
...
public sealed class SqlMaintenanceRequest
{
    public string ProfileId { get; set; } = string.Empty;
    public string DatabaseName { get; set; } = string.Empty;
    public string Schema { get; set; } = string.Empty;
...
public sealed class SqlMaintenanceResultDto
{
    public bool Success { get; set; }
    public string Message { get; set; } = string.Empty;
    public List<SqlColumnDto> Columns { get; set; } = [];
...
public sealed class SqlProcessDto
{
...
public sealed class SqlKillProcessRequest
{
    public string ProfileId { get; set; } = string.Empty;
    public string ProcessId { get; set; } = string.Empty;
}

public sealed class SqlVariableDto
{
    public string Name { get; set; } = string.Empty;
    public string Value { get; set; } = string.Empty;
    public string Group { get; set; } = "variable";
}

public sealed class SqlDesignerRequest
{
    public string ProfileId { get; set; } = string.Empty;
    public string DatabaseName { get; set; } = string.Empty;
    public string Search { get; set; } = string.Empty;
...
public sealed class SqlDesignerDto
{
    public string DatabaseName { get; set; } = string.Empty;
    public List<SqlDesignerTableDto> Tables { get; set; } = [];
    public List<SqlDesignerRelationDto> Relations { get; set; } = [];
}

public sealed class SqlDesignerTableDto
{
    public string Schema { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public string FullName { get; set; } = string.Empty;
...
public sealed class SqlDesignerRelationDto
{
    public string ConstraintName { get; set; } = string.Empty;
...
public sealed class DynamicDnsConfigDto
{
...
public sealed class DynamicDnsPublicIpDto
{
...
public sealed class DynamicDnsAccountDto
{
    ...
    public string Provider { get; set; } = "noip";
    ...
    public List<DynamicDnsDomainDto> Domains { get; set; } = [];
...
public sealed class DynamicDnsDomainDto
{
    [JsonPropertyName("id")]
    public string Id { get; set; } = Guid.NewGuid().ToString("N");
...
public sealed class DynamicDnsLogDto
{
    [JsonPropertyName("id")]
    public string Id { get; set; } = Guid.NewGuid().ToString("N");
...
public sealed class DynamicDnsResponseDto
{
    public string DynamicFilePath { get; set; } = string.Empty;
    public DynamicDnsConfigDto Config { get; set; } = new();
}

public sealed class DynamicDnsAccountRequest
{
    public DynamicDnsAccountDto Account { get; set; } = new();
}

public sealed class DynamicDnsDomainRequest
{
    public string AccountId { get; set; } = string.Empty;
...
public sealed class DynamicDnsBulkUpdateResultDto
{
    public bool Success { get; set; }
    public string Message { get; set; } = string.Empty;
...
public sealed class LocalOpenResultDto
{
    public bool Success { get; set; }
    public string Message { get; set; } = string.Empty;
}
