...
namespace ConfigTool
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<DynamicDnsConfigService>();
            builder.Services.AddSingleton<DynamicDnsUpdateService>();
            builder.Services.AddSingleton<GitAdminService>();
            builder.Services.AddSingleton<ThemeConfigService>();
            builder.Services.AddSingleton<ConfigToolOperationCancellationService>();
            builder.Services.AddSingleton<ILocalExplorerService, LocalExplorerService>();
